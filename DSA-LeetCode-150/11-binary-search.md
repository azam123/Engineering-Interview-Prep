...
The iterative solution is optimal for this problem because it uses logarithmic time and constant auxiliary space. A recursive implementation is possible but uses `O(log n)` call-stack space.
